<!-- 
This is the Scientific Writer GEMINI.md template.
Generated by the gemini-scientific-writer plugin.
For more information, see: https://github.com/K-Dense-AI/gemini-scientific-writer
-->
...
2. **Required Format:** 
   ...
   - Template location: `.gemini/skills/hypothesis-generation/assets/hypothesis_report_template.tex`
   - Style file: `.gemini/skills/hypothesis-generation/assets/hypothesis_generation.sty`
   - Formatting guide: `.gemini/skills/hypothesis-generation/assets/FORMATTING_GUIDE.md`
...
2. **Required Format:**
   ...
   - Template location: `.gemini/skills/market-research-reports/assets/market_report_template.tex`
   - Style file: `.gemini/skills/market-research-reports/assets/market_research.sty`
   - Formatting guide: `.gemini/skills/market-research-reports/assets/FORMATTING_GUIDE.md`
...
**Skill Location:** `.gemini/skills/scientific-slides/`
...
**Documentation:**
- Full skill documentation: `.gemini/skills/scientific-slides/SKILL.md`
