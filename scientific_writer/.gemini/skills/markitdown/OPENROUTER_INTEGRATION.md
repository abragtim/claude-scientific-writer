...
|-------|----------|----------|----------------|
| `anthropic/gemini-sonnet-4.5` | Anthropic | **Recommended** - Best overall for scientific analysis | ✅ |
| `anthropic/gemini-opus-4.5` | Anthropic | Excellent technical analysis | ✅ |
...
md = MarkItDown(
    llm_client=client,
    llm_model="anthropic/gemini-sonnet-4.5"  # Choose your model
)
...
**Recommended: anthropic/gemini-sonnet-4.5**
