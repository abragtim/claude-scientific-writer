...
md = MarkItDown(
    llm_client=client,
    llm_model="anthropic/gemini-sonnet-4.5"  # recommended for vision
)
...
md = MarkItDown(
    llm_client=client,
    llm_model="anthropic/gemini-sonnet-4.5",  # recommended for scientific vision
...
md = MarkItDown(
    llm_client=client,
    llm_model="anthropic/gemini-sonnet-4.5",
    llm_prompt=prompt
)
```

### Available Models via OpenRouter
- `anthropic/gemini-sonnet-4.5` - **Recommended for scientific vision**
- `anthropic/gemini-opus-4.5` - Advanced vision model
...
Options:
  ...
  --model MODEL              Model name (default: anthropic/gemini-sonnet-4.5)
